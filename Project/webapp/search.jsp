<%@page import="db.SearchVO"%>
<%@page import="java.util.List"%>
<%@page import="db.Paging"%>
  	    ...
  	    <ul class="nav justify-content-start"> 
  	     <c:forEach items="${memList}" var="co">
  	      <li class="nav-item px-4" id="shop1">
  	        <a href="ProductPage.do?product=${co.prdName }" class="nav-link" id="shop2" style="text-align: left;">
  	          <img src="./img/${co.prdName }.jpg" alt="notfound" class="img1" align="middle" /><br />
  	   	  	  <font class="menu1">${co.prdName}</font><br />
  	   	  	  <font class="menu2">${co.prdPrice}원</font>
  	        </a>
  	      </li>
  	      </c:forEach>
  	    </ul>
